...
var createNewTaskElement = function(taskString){
  ...
  listItem.classList = 'todo__item task';
  ...
  editInput.classList = 'task__input task__input_edit';
  editInput.type = "text";

  //button.edit
  var editButton = document.createElement("button");//edit button
  editButton.classList = 'task__btn btn btn_edit';
  editButton.innerText = "Edit"; //innerText encodes special characters, HTML does not.

  //button.delete
  var deleteButton = document.createElement("button");//delete button
  deleteButton.classList = 'task__btn btn btn_delete';

  var deleteButtonImg = document.createElement("img");//delete button image
  deleteButtonImg.classList = 'btn__img';
  deleteButtonImg.src="./remove.svg";
  deleteButtonImg.alt = 'delete button sign';
